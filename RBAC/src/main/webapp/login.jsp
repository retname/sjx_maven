	...
	function submitData(){
		$("#fm").form("submit",{
			...
			success:function(result){
				if(result=="y"){ //用户登录成功
                   // alert('ok');
      				window.location.href="${pageContext.request.contextPath}/doMain";
	...
	<form id="fm" method="post">
		<table cellpadding="6px" align="center">
			...
			<tr>
				<td>用户名：</td>
				<td>
					<input value="admin" type="text" id="userName" name="username" class="easyui-validatebox" required="true" style="width: 200px"/>
				</td>
			</tr>
			<tr>
				<td>密码：</td>
				<td>
					<input value="admin" type="password" id="password" name="userpwd" class="easyui-validatebox" required="true" style="width: 200px"/>
				</td>
			</tr>
			<tr>
				<td colspan="2"></td>
